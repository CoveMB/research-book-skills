...
This skill is useful because serious research books need to survive skeptical readers. The goal is not to tear down the project. The goal is to make the argument harder to dismiss.
...
Expect a peer-review style critique with a charitable restatement, strongest objections, rival explanations, missing literatures or perspectives, hidden assumptions, claims to narrow, revised stronger thesis, severity labels, and next best skill.
