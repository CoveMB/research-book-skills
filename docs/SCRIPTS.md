...
| Validate book artifacts | `python3 scripts/check_book_artifact_contract.py --path .` | Checks the shared book artifact schema, artifact-specific field boundaries, handoff passport gates, and every JSON example under `examples/book_artifacts/`. |
